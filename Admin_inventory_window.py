...
class Admin_inventory_window(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.Comment_text.place(relx=0.7, rely=0.7, relwidth=rel_width, relheight=row_height, anchor="e")
        Comment_label.place(relx=0.7, rely=0.65, relwidth=rel_width, relheight=row_height, anchor="e")
