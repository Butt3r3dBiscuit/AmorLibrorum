...
Yes = Button(window, text='Yes', command=lambda: Yes_button)
Yes.pack(pady=20)
No = Button(window, text='No', command=lambda: No_button)
No.pack()
...
def yes_button():
    lambda: Translated_label.pack()
    lambda: Translator_text.pack()
    lambda: Untranslated_label.pack()
    lambda: Untranslated_text.pack()
    lambda: Origin_text.pack()
    lambda: Origin_label.pack()
    return

def No_button():
    lambda: Translated_label.pack_forget()
    lambda: Translator_text.pack_forget()
    lambda: Untranslated_label.pack_forget()
    lambda: Untranslated_text.pack_forget()
    lambda: Origin_text.pack_forget()
    lambda: Origin_label.pack_forget()
    return
