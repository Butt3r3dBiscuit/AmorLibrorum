...
class Start_window(tk.Frame):
    def __init__(self, parent, controller):
        ...
        search_results.column("Year", anchor="center", width=50, minwidth=25)
        search_results.column("Pages", anchor="center", width=50, minwidth=25)
        search_results.column("Place", anchor="center", width=50, minwidth=25)
        ...
        search_results.column("Price", anchor="center", width=50, minwidth=25)
        search_results.column("Amount", anchor="center", width=50, minwidth=25)
